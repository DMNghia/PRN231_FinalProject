...
namespace FinalProject.Security
{
    public class JwtFilter : IAuthorizationFilter
    {
        ...
        private readonly string[] WHITE_LIST_URL = new string[] { "/api/auth/sign-in", "/api/auth/sign-up", "/api/auth/active-account/*", "/api/lesson/lesson-detail", "/api/mooc/getmoocs","/api/lesson/listlesson" };
        ...
        private readonly string[] TEACHER_ROLE_URL = new string[] { "/api/lesson/addlesson", "/api/lesson/deletelesson/*", "/api/lesson/editlesson/*", "/api/mooc/addmooc", "/api/mooc/editmooc/*", "/api/mooc/deletemooc" };
