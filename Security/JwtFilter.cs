...
namespace FinalProject.Security
{
    public class JwtFilter : IAuthorizationFilter
    {
        ...
        private readonly string[] WHITE_LIST_URL = new string[] { "/api/auth/sign-in", "/api/auth/sign-up", "/api/auth/active-account/*", "/api/Course", "/api/Course/detail/*", "/api/Course/addCourse" };
        private readonly string[] FRONT_END_URL = new string[] { "/dang-nhap", "/", "/dang-ky", "/dang-nhap-voi-google", "/google-response", "/kich-hoat-tai-khoan", "/Pricing", "/About", "/Khoa-hoc", "/Course-Detail", "/Event", "/Starter-Page", "/Trainers", "/Contact", "/UpdateCourse", "/AddCourse" };
